...
<body>
			...
			<div class="scontainer3 width-75per" style="float:left">
				...
				<div style="margin-top:20px">
					<div class="padding-15">
						...
						<ul class="sell-ing">
							<li>
								<a style="color:#000" href="/semi/myboard.bo">전체 &nbsp; <span class="selling-history select"><%=list.size()%></span></a>
							</li>
							<li>
	...
	<script>
		$('.mySlist').mouseenter(function(){
			$(this).css("background","#BDD4F2");
		});
		
		$('.mySlist').mouseleave(function(){
