				...
				<div style="margin-top:20px">
					<div class="padding-15">
						...
						<ul class="sell-ing">
							...
							<li>
								<a style="color:#000" href="/semi/myboard.bo?state=B1">승인대기중 &nbsp; <span class="selling-history  select"><%=b1 %></span></a>
							</li>
							<li>
						...
						<ul class="sell-ing">
							...
							<li>
								<a style="color:#000" href="/semi/myboard.bo?state=B1">승인대기중 &nbsp; <span class="selling-history select">0</span></a>
							</li>
							<li>
